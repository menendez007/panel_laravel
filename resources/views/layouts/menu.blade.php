    ...
    <li class="nav-item has-treeview {{ Request::is('settings*') || Request::is('menu*') || Request::is('notificationTypes*') || Request::is('currencies*') ? 'menu-open' : '' }}">
        ...
        <ul class="nav nav-treeview">
            ...
            @can('notificationTypes.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('notificationTypes*') ? 'active' : '' }}" href="{!! route('notificationTypes.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-bell-o"></i>@endif<p>{{trans('lang.notification_type_plural')}}</p></a>
                </li>
            @endcan
